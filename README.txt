...
1. WATCHLIST SORTER keeps your TradingView and Zerodha Kite watchlist sorted
   ...
   Plus an optional RVOL badge next to each symbol name on TradingView. A
   Kite list full of derivatives (futures/options/MCX) is auto-detected and
   never sorted, so an options list you keep in manual order stays put.
